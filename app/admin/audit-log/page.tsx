/**
 * /admin/audit-log — System-Wide Audit & Transparency Log
 */
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Comprehensive log of case status updates, assignments, check-in submissions, and consent changes.
      </p>
              ...
              logs.map((log) => (
                <tr key={log.id} className="hover:bg-secondary/30 transition">
                  ...
                  <td className="px-4 py-3">
                    <span className="rounded-full border border-border bg-secondary px-2 py-0.5 text-xs text-muted-foreground font-semibold">
                      {log.actor_role}
                    </span>
                  </td>

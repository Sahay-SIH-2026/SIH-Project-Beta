...
-- Index for role lookups and filtering
create index if not exists profiles_role_idx on public.profiles(role);

-- Helper function to fetch caller role with caching & security definer
...
-- ------------------------------------------------------------------------------
-- 8. Risk Scores Table (Illustrative prioritization signals, NOT clinical diagnosis)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 10. Audit Logs Table (Tamper-evident system activity log)
-- ------------------------------------------------------------------------------
